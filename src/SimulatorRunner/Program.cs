...
class Program
{
    static async Task Main()
    {
        ...
        Console.WriteLine("开始心跳任务演示（每30秒一次，10 并发，演示 5 次）...");
        ...
        var hbTask = hb.StartAsync(30000, useLogServer: true, platformHost: "127.0.0.1", platformPort: 8441, logHost: "127.0.0.1", logPort: 4565, concurrency: 10, ct: cts.Token, progress: progress);
