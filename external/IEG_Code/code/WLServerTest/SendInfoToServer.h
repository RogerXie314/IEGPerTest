...
public:
	...
	CString m_WindowsOSVersion;
        CString m_strClientIP;       // 日志发送时注入客户端IP
    ...
    //
	BOOL RegisterClientToServer(CString szComputerID, CString szClientID,CString szComputerIP, CString szVersion = _T("V300R011C01B090"), CString szOS = _T("Windows 10")); // v6: 版本/OS参数化
